...
#define Close_Precharge() HAL_GPIO_WritePin(uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_GPIO_Port, uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_Pin, GPIO_PIN_SET)
#define Open_Precharge() HAL_GPIO_WritePin(uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_GPIO_Port, uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_Pin, GPIO_PIN_RESET)
/* AIRs COMMAND MACROS */
#define Close_Air_Pos()  HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_POS_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_POS_COMMAND_Pin, GPIO_PIN_SET)
#define Open_Air_Pos() HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_POS_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_POS_COMMAND_Pin, GPIO_PIN_RESET)
#define Close_Air_Neg()  HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_NEG_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_NEG_COMMAND_Pin, GPIO_PIN_SET)
#define Open_Air_Neg() HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_NEG_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_NEG_COMMAND_Pin, GPIO_PIN_RESET)
/* AMS ERROR MACROS */
...
#define L9963TH_DIS_RESET() HAL_GPIO_WritePin(L9963TH_DIS_GPIO_INOUT_GPIO_Port, L9963TH_DIS_GPIO_INOUT_Pin, GPIO_PIN_RESET)
#define L9963TL_DIS_SET() HAL_GPIO_WritePin(L9963TL_DIS_GPIO_INOUT_GPIO_Port, L9963TL_DIS_GPIO_INOUT_Pin, GPIO_PIN_SET)
#define L9963TL_DIS_RESET() HAL_GPIO_WritePin(L9963TL_DIS_GPIO_INOUT_GPIO_Port, L9963TL_DIS_GPIO_INOUT_Pin, GPIO_PIN_RESET)
...
#define SDC_Off() HAL_GPIO_WritePin(SDC_GENERIC_SWITCH_GPIO_OUT_GPIO_Port, SDC_GENERIC_SWITCH_GPIO_OUT_Pin, GPIO_PIN_RESET)
/* AIRs signals */
#define AIRs_Pos_Int_Closed() ((uint8_t)HAL_GPIO_ReadPin(AIR_POS_INT_STATE_CLOSED_3V3_GPIO_Port, AIR_POS_INT_STATE_CLOSED_3V3_Pin))
#define AIRs_Neg_Int_Closed() ((uint8_t)HAL_GPIO_ReadPin(AIR_NEG_INT_STATE_CLOSED_3V3_GPIO_Port, AIR_NEG_INT_STATE_CLOSED_3V3_Pin))
#define AIRs_Pos_Mech_Open() ((uint8_t)HAL_GPIO_ReadPin(AIR_POS_MECH_STATE_OPEN_3V3_GPIO_Port, AIR_POS_MECH_STATE_OPEN_3V3_Pin))
#define AIRs_Neg_Mech_Open() ((uint8_t)HAL_GPIO_ReadPin(AIR_NEG_MECH_STATE_OPEN_3V3_GPIO_Port, AIR_NEG_MECH_STATE_OPEN_3V3_Pin))
/* Fuse Enable STEF*/
#define STEF01FTR_En() HAL_GPIO_WritePin(uC_GPIO_OUT_STEF01FTR_Enable_GPIO_Port, uC_GPIO_OUT_STEF01FTR_Enable_Pin, GPIO_PIN_SET)
#define STEF01FTR_Dis() HAL_GPIO_WritePin(uC_GPIO_OUT_STEF01FTR_Enable_GPIO_Port, uC_GPIO_OUT_STEF01FTR_Enable_Pin, GPIO_PIN_RESET)
/* DC BUS signals*/
