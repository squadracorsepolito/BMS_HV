...
#define En_Precharge() HAL_GPIO_WritePin(uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_GPIO_Port, uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_Pin, GPIO_PIN_SET)
#define Dis_Precharge() HAL_GPIO_WritePin(uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_GPIO_Port, uC_GPIO_OUT_DCBUS_PRCH_RLY_COMMAND_Pin, GPIO_PIN_RESET)
/* AIRs COMMAND MACROS */
#define En_Air_Pos()  HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_POS_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_POS_COMMAND_Pin, GPIO_PIN_SET)
#define Dis_Air_Pos() HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_POS_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_POS_COMMAND_Pin, GPIO_PIN_RESET)
#define En_Air_Neg()  HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_NEG_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_NEG_COMMAND_Pin, GPIO_PIN_SET)
#define Dis_Air_Neg() HAL_GPIO_WritePin(uC_GPIO_OUT_AIR_NEG_COMMAND_GPIO_Port, uC_GPIO_OUT_AIR_NEG_COMMAND_Pin, GPIO_PIN_RESET)
/* AMS ERROR MACROS */
...
#define L9963TH_BNE() HAL_GPIO_ReadPin(L9963TH_BNE_GPIO_IN_GPIO_Port, L9963TH_BNE_GPIO_IN_Pin)
#define L9963TL_BNE() HAL_GPIO_ReadPin(L9963TL_BNE_GPIO_IN_GPIO_Port, L9963TL_BNE_GPIO_IN_Pin)
