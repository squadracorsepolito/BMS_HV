...
ErrorStatus LL_ADC_DeInit(ADC_TypeDef *ADCx) {
    ...
    if (READ_BIT(ADCx->CR2, ADC_CR2_ADON) == 0UL) {
        ...
        /* Reset register CR2 */
        CLEAR_BIT(ADCx->CR2,
                  (ADC_CR2_SWSTART | ADC_CR2_EXTEN | ADC_CR2_EXTSEL | ADC_CR2_JSWSTART | ADC_CR2_JEXTEN |
                   ADC_CR2_JEXTSEL | ADC_CR2_ALIGN | ADC_CR2_EOCS | ADC_CR2_DDS | ADC_CR2_DMA | ADC_CR2_CONT |
                   ADC_CR2_ADON));
